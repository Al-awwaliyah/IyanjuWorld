...
const businesses: SearchBusiness[] = [
  {
    ...
    description:
      "Quality Ankara fabrics and fashion materials for everyday and special occasions.",
    logoUrl: "/images/businesses/aderonke-fabrics.jpg",
    category: "Fashion",
    city: "Ibadan",
    state: "Oyo",
    verified: true,
  ...
  },
  {
    ...
    description:
      "Phones, accessories and reliable consumer electronics.",
    logoUrl: "/images/businesses/techpoint-store.jpg",
    category: "Electronics",
    city: "Ibadan",
    state: "Oyo",
    verified: true,
  ...
  },
  {
    ...
    description:
      "Fashion accessories, handbags and carefully selected fashion products.",
    logoUrl: "/images/businesses/elegance-collections.jpg",
    category: "Fashion",
    city: "Osogbo",
    state: "Osun",
    verified: true,
  ...
  },
  {
    ...
    slug: "natural-touch",
    description:
      "Beauty and personal-care products made for everyday routines.",
    logoUrl: "/images/businesses/natural-touch.jpg",
    category: "Beauty & Personal Care",
    city: "Lagos",
    state: "Lagos",
    verified: true,
  ...
  {
    id: "business-005",
    name: "HomeStyle Nigeria",
    slug: "homestyle-nigeria",
    description:
      "Practical home and kitchen products for modern Nigerian homes.",
    logoUrl: "/images/businesses/homestyle-nigeria.jpg",
    category: "Home & Living",
    city: "Akure",
    state: "Ondo",
    verified: true,
